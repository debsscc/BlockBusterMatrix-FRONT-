          ...
          <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
            <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:p-8">
              ...
              <div className="space-y-4">
                ...
                <a
                  href="#"
                  className="w-full flex justify-center items-center bg-yellow-500 text-black py-2.5 rounded-lg hover:bg-yellow-600 transition duration-300 ease-in-out"
                >
                  Proceed to Checkout
                </a>
