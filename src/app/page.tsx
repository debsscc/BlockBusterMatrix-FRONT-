  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-screen-xl">
        <h1 className="mt-4 mb-4 text-w-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-6xl dark:text-white">BlockBuster Matrix <span className="text-red-600 dark:text-red-500">the world's #1</span> rental house game.</h1>
